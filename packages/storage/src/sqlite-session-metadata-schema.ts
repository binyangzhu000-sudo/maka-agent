...
export const SQLITE_SESSION_METADATA_REQUIRED_TABLES = [
  ...
  ['session_metadata_tombstones', 2],
  ['subagent_spawns', 5],
  ['agent_graph_intent_claims', 6],
  ['agent_graph_schedule_updates', 7],
  ['agent_graph_operator_provisions', 9],
  ['agent_graph_client_projections', 10],
  ['agent_graph_client_operator_projections', 10],
  ['agent_graph_client_terminal_activity', 10],
  ['agent_graph_client_applied_records', 10],
  ['agent_graph_supervisor_wakes', 11],
  ['agent_graph_supervisor_wake_attempts', 11],
  ['sandbox_boundary_log', 13],
  ['session_create_claims', 15],
  ['session_catalog_state', 16],
  ['session_catalog_projection', 16],
  ['session_catalog_label_projection', 17],
  ['session_messages', 20],
  ['projects', 21],
  ['project_locations', 21],
  ['project_aliases', 21],
] as const;
